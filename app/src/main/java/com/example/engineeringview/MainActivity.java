package com.example.engineeringview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initSwitch(){
        ...
        simple = findViewById(R.id.simplViewLayout);
        engineering = findViewById(R.id.engineeringViewLayout);
        switchBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(simple.getVisibility() == 0){
